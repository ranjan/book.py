...
DATABASE_NAME = 'demoapp'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'h0hb*@s#3*98s1s5u7t&acqv5w#!0vdb!)*_l7-#j#2s=p(i^b'
...
TEMPLATE_DIRS = (
    ...
    "/home/ranjan/Project/demoapp/templates"
)
